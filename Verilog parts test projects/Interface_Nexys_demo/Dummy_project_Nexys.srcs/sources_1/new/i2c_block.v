...
module i2c_block #(
    ...
    localparam S_START      = 7'b0000010;
    localparam S_LOAD_ADDR  = 7'b0000100;
    localparam S_ACK_NACK   = 7'b0001000;
    localparam S_LOAD_DATA  = 7'b0010000;
    localparam S_READ_DATA  = 7'b0100000;
    localparam S_STOP       = 7'b1000000;
