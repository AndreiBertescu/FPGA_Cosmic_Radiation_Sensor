...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L ecc_v2_0_16 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ecc_0_d xil_defaultlib.ecc_0_d xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ecc_0_d -key {Behavioral:sim_1:Functional:ecc_0_d} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Apps/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ecc_0_d.wdb xsim.dir libdpi.so)
