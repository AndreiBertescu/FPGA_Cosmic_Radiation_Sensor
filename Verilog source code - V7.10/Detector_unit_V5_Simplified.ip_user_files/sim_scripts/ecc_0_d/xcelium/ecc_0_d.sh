...
#
# Script generated by Vivado on Fri Jul 25 11:59:01 +0300 2025
...
#
# Usage        : ecc_0_d.sh
#                ecc_0_d.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ecc_0_d.sh [-reset_run]
#                ecc_0_d.sh [-reset_log]
#                ecc_0_d.sh [-help]
#
...
#                script (type 'ecc_0_d.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname ecc_v2_0_16 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm ecc_v2_0_16 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "ecc_0_d.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ecc_0_d.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work ecc_v2_0_16 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ecc_0_d xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ecc_0_d -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ecc_0_d_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ecc_0_d.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ecc_0_d.sh [-help]\n\
Usage: ecc_0_d.sh [-step]\n\
Usage: ecc_0_d.sh [-lib_map_path]\n\
Usage: ecc_0_d.sh [-reset_run]\n\
Usage: ecc_0_d.sh [-reset_log]\n\
Usage: ecc_0_d.sh [-keep_index]\n\
Usage: ecc_0_d.sh [-noclean_files]\n\n\
