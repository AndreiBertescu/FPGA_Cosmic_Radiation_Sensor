...
design_libs=(xpm ecc_v2_0_16 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work ecc_v2_0_16 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ecc_0_d xil_defaultlib.glbl -o ecc_0_d_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ecc_0_d_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key ecc_0_d_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ecc_0_d_simv.daidir vcs_lib c.obj)
