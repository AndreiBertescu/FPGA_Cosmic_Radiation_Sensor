...
design_libs=(xpm sem_v4_1_15 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work sem_v4_1_15 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.sem_0 xil_defaultlib.glbl -o sem_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./sem_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key sem_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc sem_0_simv.daidir vcs_lib c.obj)
