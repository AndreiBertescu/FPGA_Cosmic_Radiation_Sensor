...
#
# Script generated by Vivado on Fri Jul 25 11:35:48 +0300 2025
...
#
# Usage        : sem_0.sh
#                sem_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sem_0.sh [-reset_run]
#                sem_0.sh [-reset_log]
#                sem_0.sh [-help]
#
...
#                script (type 'sem_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname sem_v4_1_15 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm sem_v4_1_15 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "sem_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sem_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work sem_v4_1_15 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sem_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sem_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sem_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./sem_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: sem_0.sh [-help]\n\
Usage: sem_0.sh [-step]\n\
Usage: sem_0.sh [-lib_map_path]\n\
Usage: sem_0.sh [-reset_run]\n\
Usage: sem_0.sh [-reset_log]\n\
Usage: sem_0.sh [-keep_index]\n\
Usage: sem_0.sh [-noclean_files]\n\n\
