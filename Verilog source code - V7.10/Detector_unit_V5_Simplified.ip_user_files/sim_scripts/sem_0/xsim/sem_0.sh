...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L sem_v4_1_15 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sem_0 xil_defaultlib.sem_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sem_0 -key {Behavioral:sim_1:Functional:sem_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sem_0.wdb xsim.dir libdpi.so)
