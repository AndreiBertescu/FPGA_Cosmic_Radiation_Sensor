...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/andre/Documents/IMPORTANT/CODE/Verilog/AICORS/Detector_unit_V5_Simplified/Detector_unit_V5_Simplified.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
